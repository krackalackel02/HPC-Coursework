...
The ``PrintConfiguration'' test utilised a stream-buffer as shown in \code\ref{lst:LDCPrintConfigTest}. After rerouting the output stream, the printed information
...
\begin{equation}
    ...
    \label{eq:vort}
\end{equation}
As seen in \code\ref{lst:SCGAnalyticalTest} the domain used was of size 6,000,000 grid points and could be run with a variable number of MPI ranks as shown in \code\ref{lst:MyTest} through the Boost global fixture.
